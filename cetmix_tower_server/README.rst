...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:02d2945522a32036d6c10994b8e2b6370053e340e027fce3bfa2662622211da8
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
"reference" field blank to generate a reference automatically. Enter
host key for validating the server's host key. Click to ``Show key`` to
auto getting host key of the server. You can also select a color which
is used to mark a server in the kanban view.
...
- **Skip Host Key**: Skip validation host key. IMPORTANT: In the Secure
  Shell (SSH) protocol, host keys are used to verify the identity of
  remote hosts. Accepting unknown host keys may leave the connection
