...
OVH_HELP_TEXT_HTML = _(
    ...
    "Please check the <a href='https://eu.api.ovh.com/console/?section=%2FallDom&branch=v1' target='_blank'>OVH Documentation</a> for detailed information about the services and methods.</li>"  # noqa: E501
    "</ul>"
)
