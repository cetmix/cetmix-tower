...
[cetmix_tower_server](cetmix_tower_server/) | 16.0.1.2.0 |  | Manage servers and applications from Odoo
[cetmix_tower_server_notify_backend](cetmix_tower_server_notify_backend/) | 16.0.1.0.0 |  | Backend notifications for Cetmix Tower
[cetmix_tower_server_queue](cetmix_tower_server_queue/) | 16.0.1.1.0 |  | Cetmix Tower asynchronous task execution using 'queue_job'
