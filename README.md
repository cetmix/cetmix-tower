...
--- | --- | --- | ---
[cetmix_tower](cetmix_tower/) | 14.0.1.0.10 |  | Odoo SAAS Server Application Management
...
[cetmix_tower_server](cetmix_tower_server/) | 14.0.1.0.9 |  | Manage servers and applications from Odoo
[cetmix_tower_server_notify_backend](cetmix_tower_server_notify_backend/) | 14.0.1.0.1 |  | Backend notifications for Cetmix Tower
[cetmix_tower_server_queue](cetmix_tower_server_queue/) | 14.0.1.0.6 |  | Cetmix Tower asynchronous task execution using 'queue_job'
[cetmix_tower_yaml](cetmix_tower_yaml/) | 14.0.1.0.6 |  | Cetmix Tower YAML export/import
