...
--- | --- | --- | ---
[cetmix_tower](cetmix_tower/) | 16.0.1.0.7 |  | Odoo SAAS Server Application Management
[cetmix_tower_git](cetmix_tower_git/) | 16.0.1.0.2 |  | Cetmix Tower Git Management Tools
[cetmix_tower_server](cetmix_tower_server/) | 16.0.1.0.7 |  | Manage servers and applications from Odoo
...
[cetmix_tower_yaml](cetmix_tower_yaml/) | 16.0.1.0.4 |  | Cetmix Tower YAML export/import
