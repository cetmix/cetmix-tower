...
class ProductAttributeValue(models.Model):
    ...
    tower_variable_value_id = fields.Many2one(
        comodel_name="cx.tower.variable.value",
        help="Tower variable value this attribute value represents",
        readonly=True,
    )
    ...
    @api.depends("tower_option_id", "tower_variable_value_id")
    def _compute_tower_variable_id(self):
        ...
        for record in self:
            ...
            elif record.tower_variable_value_id:
                record.tower_variable_id = record.tower_variable_value_id.variable_id
            else:
    ...
    def _compute_is_from_tower(self):
        ...
        for record in self:
            record.is_from_tower = bool(
                record.tower_option_id or record.tower_variable_value_id
            )
    ...
    def get_tower_actual_value(self):
        ...
        elif self.tower_variable_value_id:
            return self.tower_variable_value_id.value_char
    ...
    def action_open_tower_record(self):
        ...
        if self.tower_option_id:
            ...
            return {
                "type": "ir.actions.act_window",
                "name": "Tower Variable Value",
                "res_model": "cx.tower.variable.value",
                "res_id": self.tower_variable_value_id.id,
                "view_mode": "form",
                "target": "current",
            }
